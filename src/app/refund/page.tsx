// ── RefundPage ────────────────────────────────────────────────────────
// Mock หน้าขอ refund — มี Navbar ไม่มี Footer, ยังไม่เชื่อมกับหน้าไหน (เข้าตรงๆ ผ่าน /refund)
// สอง view ในไฟล์เดียว: ฟอร์มขอ refund (default) → หน้ายืนยันสำเร็จ (หลังกด Request Refund)
// แก้ไขได้: MOCK_BOOKING (ห้อง, วันที่, ยอด refund) — ยังไม่ต่อ backend จริง
...
const CANCELLATION_DATE = new Date(2025, 9, 20);
const GUESTS = 2;
const REFUND_AMOUNT = 2300;
						...
						<div className="flex w-full max-w-184.5 flex-col items-start overflow-hidden rounded bg-[#465C50] shadow-[4px_4px_16px_rgba(0,0,0,0.08)]">
							<div className="flex w-full flex-col items-center gap-3 bg-[#2F3E35] px-6 py-10 text-center">
								...
								<p className="max-w-172.5 [font-family:var(--font-inter)] text-sm leading-[150%] tracking-[-0.02em] text-[#ABC0B4]">
									The cancellation is complete. You will receive an email with a detail and refund within 48 hours.
								</p>
							</div>
					...
					>
							...
							<div className="flex w-full flex-1 flex-col gap-10">
								<div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-end">
									...
									<div className="flex flex-col items-start gap-2 lg:items-end">
										<span className="[font-family:var(--font-inter)] text-base leading-[150%] tracking-[-0.02em] text-[#2A2E3F]">
											Total Refund
										</span>
						...
						<div className="mt-10 flex items-center justify-between border-t border-[#E4E6ED] py-10">
							...
							<button
								...
								className="flex h-12 w-77.25 cursor-pointer items-center justify-center rounded bg-[#C14817] px-8 py-4 [font-family:var(--font-open-sans)] text-base font-semibold text-white transition-transform duration-150 hover:bg-[#A93F13] active:scale-90"
							>
								Request Refund
							</button>
						</div>
