...
export async function buildChatbotResponse(payload: Record<string, unknown>, event: { requestId: string; intent: ChatbotIntent; mode: ChatbotResponseMode; fallbackReason?: string | null; handoffReason?: HandoffReason | null }) {
  try {
